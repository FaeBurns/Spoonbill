...
public class MoveDownInCollectionCommand<T> : SimpleCommand
{
    private readonly ObservableCollection<T> m_collection;

    public MoveDownInCollectionCommand(ObservableCollection<T> collection)
    {
